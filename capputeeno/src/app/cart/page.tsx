...
export default function CartPage(){
    ...
    const cartTotal = formatPriceValue(calculateTotal(value))
    const deliveryFee = 4000;
    const cartTotalWithDelivery = formatPriceValue(calculateTotal(value) + deliveryFee)
        ...
        <DefaultPageLayout>
            <Container>
                ...
                <CartResultContainer>
                    ...
                    <TotalItem isBold={false}>
                        <p>Entrega</p>
                        <p>{formatPriceValue(deliveryFee)}</p>
                    </TotalItem>
                    <Divider/>
                    <TotalItem isBold>
                        <p>Total</p>
